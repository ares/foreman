...
class ProvisioningTemplatesControllerTest < ActionController::TestCase
  ...
  test "create invalid" do
    ...
    post :create, { :provisioning_template => {:name => nil} }, set_session_user
    assert_template 'new'
  end

  test "create valid" do
    ProvisioningTemplate.any_instance.stubs(:valid?).returns(true)
    post :create, { :provisioning_template => {:name => "MyConfig"} }, set_session_user
  ...
  test "update invalid" do
    ProvisioningTemplate.any_instance.stubs(:valid?).returns(false)
    put :update, {:id => templates(:pxekickstart).to_param, :provisioning_template => { :name => provisioning_templates(:pxekickstart).name } }, set_session_user
    assert_template 'edit'
  end
