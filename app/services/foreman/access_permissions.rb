...
Foreman::AccessControl.map do |permission_set|
  ...
  permission_set.security_block :filters do |map|
    ...
    map.permission :edit_filters,    {:filters => [:edit, :update, :reset_filter_taxonomies], :permissions => [:index],
  ...
  permission_set.security_block :roles do |map|
    ...
    map.permission :create_roles,  {:roles => [:new, :create, :clone],
                                    :'api/v2/roles' => [:create]}
    map.permission :edit_roles,    {:roles => [:edit, :update, :reset_filter_taxonomies],
                                    :'api/v2/roles' => [:update]}
