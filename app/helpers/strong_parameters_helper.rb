module StrongParametersHelper
  ...
  def foreman_params(param_name = nil)
    permitted_params = "permitted_#{param_name || controller_name.singularize}_attributes"
  ...
  def permitted_provisioning_template_attributes
    permitted_attributes.provisioning_template_attributes +
