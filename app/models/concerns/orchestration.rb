...
module Orchestration
  ...
  def setup_clone(&block)
    ...
    @old = setup_object_clone(self, &block)
      # NOTE for reviewers - I tested in rails 2 and there was an issue like this
      #   host.architecture_id      # => 1
      #   host.architecture_id = 2
      #   host.architecture         # => <Architecture id: 1...
      # but in Rails 3 it gives us  # => <Architecture id: 2...
      # so we don't need it anymore
      # TODO remove this comment after review and before merge
  end
